...
import {  setReplyandLikes } from "../state/slices/postSlice";
...
const Actions = ({ post }) => {
  ...
  const dispatch=useDispatch();
	...
	const handleLikeAndUnlike = async () => {
		if (!currentUser) return showToast("Error", "You must be logged in to like a post", "error");
		if (isLiking) return;
		setIsLiking(true);
		try {
			...
			if (!liked) {
				...
				dispatch(setReplyandLikes(updatedPosts));
			} else {
